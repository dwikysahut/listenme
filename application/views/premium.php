...
<head>
	...
	<!-- Stylesheets
		...
		<link rel="stylesheet" href="<?php echo base_url() ?>assets/style.css?version=51" type="text/css" />
						...
						<!-- <div id="section-pricing" class="page-section p-0 m-0">
							...
							<div id="pricing-switch" class="row pricing col-mb-50 mb-0">
								<div class="col-md-6">
									...
									<div class="pricing-box pricing-simple p-5 bg-dark border-top border-primary dark">
										...
										<div class="pricing-price">
											<span class="price-unit">&dollar;</span>0
										</div>
								...
								<div class="col-md-6">
									...
									<div class="pricing-box pricing-simple p-5 bg-dark border-top border-danger dark">
										<div class="pricing-title">
											<span class="text-danger">Most Popular</span>
											<h3>Premium</h3>
										</div>
										<div class="pricing-price">
											<div class="pts-switch-content-left"><span class="price-unit">&dollar;</span>19</div>
											<div class="pts-switch-content-right"><span class="price-unit">&dollar;</span>149</div>
										</div>
										<div class="pricing-features dark">
											<ul>
												<li><strong>Full</strong> Access</li>
							...
							<div class="col-md-4">
									...
									<div class="pricing-box pricing-simple p-5 bg-dark border-top border-success dark">
										...
										<div class="pricing-price">
											<div class="pts-switch-content-left"><span class="price-unit">&dollar;</span>49</div>
											<div class="pts-switch-content-right"><span class="price-unit">&dollar;</span>399</div>
										</div>
										<div class="pricing-features dark">
											<ul>
												<li><strong>Full</strong> Access</li>
